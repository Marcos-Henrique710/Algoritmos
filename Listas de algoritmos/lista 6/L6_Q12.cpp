...
*/
struct PessoaPesq{ string nome; int sexo; string corOlhos; double altura; double peso; string dataNasc; };
void q10(){
    int n; cout<<"Quantas pessoas? "; cin>>n;
    vector<PessoaPesq> v(n);
    for(int i=0;i<n;i++) cin>>v[i].nome>>v[i].sexo>>v[i].corOlhos>>v[i].altura>>v[i].peso>>v[i].dataNasc;
