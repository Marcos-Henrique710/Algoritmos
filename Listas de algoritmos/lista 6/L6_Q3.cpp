...
void q3(){
    vector<Cliente> v(2);
    for(int i=0;i<2;i++){ cout<<"Identidade Nome Endereco Telefone\n"; cin>>v[i].identidade; cin.ignore(); getline(cin,v[i].nome); getline(cin,v[i].endereco); getline(cin,v[i].telefone); }
